...
class NeuralNetworkTests extends Suite with PrivateMethodTester {
  ...
  def testNetworkTuneUp {
    ...
    val w10 = 0.5 + net.alpha*0.5*delta10
    val w11 = 0.5 + net.alpha*0.5*delta11
    ...
    val w00 = 0.5 + net.alpha*0.5*delta00 
    val w01 = 0.5 + net.alpha*0.5*delta01 
    val w02 = 0.5 + net.alpha*0.5*delta02
